  ...
  return (
    <div className="mt-[100px] container-lg text-white">
      ...
      <div className="row g-4 gutter-1 mt-3 mb-5 p-4 justify-center">
        {data.length > 0 &&
          data.map((data) => (
            <div key={data.id} className="mx-3 col-2 p-3 rounded-lg bg-[#181818] shadow-lg">
              ...
              <div className="text-slate-300 fw-semibold text-md mx-2">{data.title.length > 30 ? data.title.substr(0, 30) + '...' : data.title}</div>
              ...
              <div className="flex justify-between items-center my-2 text-yellow-600">
                <div className="text-white rounded-xl px-4 py-1 bg-yellow-600 cursor-pointer hover:opacity-75">Add to cart</div>
